...
export default function Footer() {
  return (
    <footer className="bg-[#BB1D1D] text-white">
      {/* Main Footer Content */}
      <div style={{ fontFamily: "Manrope", fontWeight:'bold' }} className="container mx-auto px-4 py-8 lg:py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 md:gap-8 lg:gap-2">
          ...
          <div className="lg:col-span-1">
            <h3 className="text-[22px] leading-[24px] font-[800] mb-3 tracking-[0.3em]">
              QUICK LINKS
            </h3>
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-5">
              <div>
                <h4 className="font-[800] text-[20px] leading-[20px] mb-2">
                  Monday - Saturday
                </h4>
                <p className="text-[#ffffff] font-[500] text-[16px] leading-[16px] ">
                  09:00 AM - 09:00 PM
                </p>
              </div>
              <div>
                <h4 className="font-[800] mb-2">Sunday</h4>
                <p className="text-[#ffffff] font-[500] text-[16px] leading-[16px]">
                  11:00 AM - 08:00 PM
                </p>
              </div>
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-3 mb-8">
              <div className="flex items-center gap-3">
                ...
                <span className="text-[16px] font-[500]">+91 7879088134</span>
              </div>
              <div className="flex items-center gap-3">
                <Mail className="w-4 h-4 text-red-200" />
                <span className="text-[16px] font-[500]">inforsonchi@gmail.com</span>
              </div>
              <div className="flex items-start gap-3">
                <MapPin className="w-4 h-4 text-red-200 mt-0.5" />
                <span className="text-[16px] font-[500]">Vijay Nagar, Indore, India</span>
              </div>
            </div>

            {/* Social Media */}
            <div>
              <h4 className="text-[18px] leading-[24px] font-[800] mb-3 tracking-[0.3em]">
                FOLLOW US ON
              </h4>
      ...
      <div className="bg-[#F2ECE0] text-[#BB1D1D]">
        <div className="container mx-auto px-4 py-4">
          <div style={{fontFamily: "Manrope", fontWeight:'500'}} className="flex flex-col sm:flex-row justify-between items-center gap-4 text-sm sm:text-base md:text-[18px] leading-snug md:leading-[27px] text-center sm:text-left">
            <p className="w-full sm:w-auto">
            Copyright ©2023. All Rights Reserved. Sonchi
            </p>
